...
doom_one.set_colorscheme = function()
  ...
  if config.plugins.blink then
    ...
    set_hl("BlinkCmpLabel", { bg = config.ui.transparent_background and "NONE" or palette.bg, fg = palette.fg })
    set_hl("BlinkCmpLabelDescription", { bg = config.ui.transparent_background and "NONE" or palette.bg, fg = palette.base5 })
    set_hl("BlinkCmpLabelDetail", { link = "BlinkCmpLabelDescription" })
  ...
  if config.plugins.mini_pick then
    ...
    set_hl("MiniPickMatchCurrent", { fg = palette.bg, bold = true, bg = palette.blue })
